...
public class LogTailServiceTest {
     ...
     * It creates a temporary log file with 11 lines and initializes the LogTailService
     */
    @BeforeEach
    public void setup() throws IOException {
        ...
        // Initialize LogTailService with the test file and a mocked messaging template
